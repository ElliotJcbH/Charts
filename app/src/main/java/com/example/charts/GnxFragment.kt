...
class GnxFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_gnx, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val playButton = view.findViewById<AppCompatImageView>(R.id.btnPlay4)
    ...
    private fun openSpotifyAlbum() {
        ...
        val albumUrl = "https://open.spotify.com/album/0hvT3yIEysuuvkK73vgdcW?si=g7CTR-sASIOF2J-vVFfjRw"
