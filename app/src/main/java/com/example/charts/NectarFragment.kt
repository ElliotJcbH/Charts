...
class NectarFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_nectar, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val playButton = view.findViewById<AppCompatImageView>(R.id.btnPlay3)
    ...
    private fun openSpotifyAlbum() {
        ...
        val albumUrl = "https://open.spotify.com/album/6gJ8VKn5PAFcCIVaf3B2uE?si=3-m3gy1FStKuxX4vKnAOCQ"
